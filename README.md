...
> 🚀 Built with [Soft UI Dashboard Generator](https://appseed.us/generator/soft-ui-dashboard/), timestamp `2022-09-06 05:22`
...
```bash
$ # Get the code
$ git clone https://github.com/appseed-projects/d525671c-98c4-4fe5-89ed-6671961a6be1.git
$ cd d525671c-98c4-4fe5-89ed-6671961a6be1
```
